...
const jiraClient = new client_js_1.JiraMCPClient(jiraConfig);
// Tool definitions
const TOOLS = [
    {
    ...
    try {
        switch (name) {
            ...
            case 'jira_create_issue': {
                const { projectKey, summary, description, type } = args;
            ...
            case 'jira_update_issue_status': {
                const { issueIdOrKey, statusName } = args;
            ...
            case 'jira_close_issue': {
                const { issueIdOrKey, resolution } = args;
            ...
            case 'jira_update_comment': {
                const { issueIdOrKey, commentId, comment } = args;
            ...
            case 'jira_create_issue_link': {
                const { type, inwardIssue, outwardIssue, comment } = args;
...
//# sourceMappingURL=jira-mcp-server.js.map